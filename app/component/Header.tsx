        ...
        <header className="p-5 shadow-lg w-full bg-blue-400 dark:bg-blue-900 flex justify-between items-center">
          <div className="flex items-center gap-4">
            ...
            <div className="flex gap-6">
              ...
              <Link href="/game" className="text-white dark:text-gray-100 hover:text-gray-200 dark:hover:text-gray-300 font-medium text-lg transition-colors duration-200">Product</Link>
